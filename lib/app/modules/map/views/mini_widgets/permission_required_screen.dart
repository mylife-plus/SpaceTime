...
class PermissionRequiredScreen extends StatelessWidget {
                  ...
                  children: [
                        ...
                        onPressed:
                            permissionService.hasLocationPermission.value
                                ...
                                : () async {
                                  ...
                                  if (granted) {
                                    // Permission was granted - force MapController to sync state
                                    try {
                                      final mapController =
                                          Get.find<MapControllerNew>();
                                      debugPrint(
                                        '[PermissionRequiredScreen] 🔄 Permission granted! Forcing MapController state sync...',
                                      );
                                      await mapController
                                          .forcePermissionStateCheck();
                                    } catch (e) {
                                      debugPrint(
                                        '[PermissionRequiredScreen] Error syncing MapController state: $e',
                                      );
                                    }
                                  } else {
                                    Get.snackbar(
                    ...
                    Container(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                          _showPermissionDialog(context, uiController);
                        },
                        icon: Icon(
  ...
  void _showPermissionDialog(BuildContext context, UiController uiController) {
    Get.dialog(
      Dialog(
        backgroundColor: Colors.transparent,
        child: Container(
  ...
  Widget _buildPermissionItem(String text, UiController uiController) {
    return Padding(
