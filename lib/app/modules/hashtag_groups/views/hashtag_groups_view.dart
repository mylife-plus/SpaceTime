...
import 'mini_widgets/hashtag_detail_view.dart';
import 'mini_widgets/hashtag_groups_title.dart';
import '../../../routes/app_pages.dart';
import '../../memories/controllers/memory_controller.dart';

class HashtagGroupsView extends GetView<HashtagGroupsController> {
  const HashtagGroupsView({super.key});
            ...
            (context) => Positioned(
              ...
              child: Material(
                ...
                child: TagMentionBottomSheet(
                  onItemSelected: (item) {
                    final hashtag = item.substring(1);
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  '# hashtag groups added successfully',
                                ),
                              ),
                            );
                          },
            ...
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    HashtagGroupsTitle(
                      title: AppTexts.sport,
                      trailingText: '6',
                      trailingIcon: Icons.arrow_forward_ios,
                      onTap: () {
                        // Ensure controller exists before navigation
                        if (!Get.isRegistered<HashtagGroupsController>()) {
                          Get.put(HashtagGroupsController());
                        }
                        Get.to(() => HashtagDetailView());
                      },
                      showDivider: true,
                    ),
                    HashtagGroupsTitle(
                      title: AppTexts.exercise,
                      trailingText: '10',
                      trailingIcon: Icons.arrow_forward_ios,
