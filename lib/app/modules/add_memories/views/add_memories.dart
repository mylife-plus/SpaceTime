...
class AddMemoriesView extends GetView<AddMemoriesController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final searchOpen = controller.isSearchActive.value;

      final SystemUiOverlayStyle systemUi;
      if (filterOpen) {
        systemUi = AppSystemUi.overlayStyleMatchingSurface(
          surface: uiController.filterOverlayBackgroundColor,
          darkTheme: isDark,
        );
      } else if (searchOpen) {
        systemUi = AppSystemUi.overlayStyleMatchingSurface(
          surface: uiController.searchOverlayBackgroundColor,
          darkTheme: isDark,
        );
      } else if (isDark) {
        systemUi = AppSystemUi.overlayStyle(dark: true);
      } else {
        systemUi = AppSystemUi.overlayStyleLightStatusIcons(dark: false);
      }

      final shellColor = filterOpen
