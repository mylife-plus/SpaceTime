...
class UiTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Theme chrome is reactive; [trailing] must come from the parent rebuild so
    // selection checkmarks update on Android without a nested Obx cache miss.
    return Obx(() {
      ...
      return Column(
        children: [
          InkWell(
            onTap: onTap,
            child: Container(
              color: isDark ? controller.darkSurfaceColor : Colors.white,
